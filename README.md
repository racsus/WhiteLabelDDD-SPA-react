...
To configure correctly this project, you will need to follow these steps:

- Modify auth_config.json file to add the Auth0 data
- Modify the file .env to add the correct API url
- Modify the file src/containers/TheHeaderDropdown.js to add the correct endpoint to get the token data.
